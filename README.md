...
[![pkg](https://img.shields.io/badge/dev-reference-007d9c?logo=go&logoColor=white&style=flat)](https://pkg.go.dev/github.com/geiqin/wechat?tab=doc)
...
```
import "github.com/geiqin/wechat"
```
